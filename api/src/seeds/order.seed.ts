    ...
    const orders = [
        {
            table: 1,
            items: [
                { _id: drinks[0]._id, status: OrderMenuItemStatus.Done },
                { _id: drinks[0]._id, status: OrderMenuItemStatus.Done },
                { _id: drinks[1]._id, status: OrderMenuItemStatus.Done },
            ],
        ...
        },
        {
            ...
            items: [
                { _id: drinks[0]._id, status: OrderMenuItemStatus.Done },
                { _id: drinks[1]._id, status: OrderMenuItemStatus.Done },
                { _id: drinks[2]._id, status: OrderMenuItemStatus.Done },
                { _id: drinks[3]._id, status: OrderMenuItemStatus.Done },
            ],
            status: OrderStatus.Paid,
            type: MenuItemCategory.Drinks
        },
        {
            ...
            items: [
                ...
                { _id: drinks[2]._id, status: OrderMenuItemStatus.Done },
                { _id: drinks[3]._id, status: OrderMenuItemStatus.Done },
                { _id: drinks[4]._id, status: OrderMenuItemStatus.Done },
            ],
            status: OrderStatus.Paid,
            type: MenuItemCategory.Drinks
        },
