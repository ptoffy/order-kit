...
export class TableService {
  ...
  list(waiterOnly: boolean = false, withWaiter: boolean = false): Observable<Table[]> {
    return this.apiService.get(`${this.basePath}?waiterOnly=${waiterOnly}&withWaiter=${withWaiter}`)
  }
